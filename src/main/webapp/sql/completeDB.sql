...
--
-- Temporary view structure for view `activecampaigns`
--

DROP TABLE IF EXISTS `activecampaigns`;
/*!50001 DROP VIEW IF EXISTS `activecampaigns`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `activecampaigns` AS SELECT 
 1 AS `id`,
 1 AS `name`,
 1 AS `cause`,
 1 AS `target_region_id`*/;
...
CREATE TABLE `donation` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `charity_id` (`charity_id`),
  KEY `donationdetail` (`donor_name`,`donation_amount`),
...
--
-- Temporary view structure for view `donationsummary`
--

DROP TABLE IF EXISTS `donationsummary`;
/*!50001 DROP VIEW IF EXISTS `donationsummary`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `donationsummary` AS SELECT 
 1 AS `id`,
 1 AS `name`,
 1 AS `cause`,
 1 AS `address`,
...
--
-- Temporary view structure for view `finishedcampaigns`
--

DROP TABLE IF EXISTS `finishedcampaigns`;
/*!50001 DROP VIEW IF EXISTS `finishedcampaigns`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `finishedcampaigns` AS SELECT 
 1 AS `name`,
 1 AS `charity_id`,
 1 AS `target_region_id`,
 1 AS `start_date`,
...
--
-- Temporary view structure for view `hungercampaigns`
--

DROP TABLE IF EXISTS `hungercampaigns`;
/*!50001 DROP VIEW IF EXISTS `hungercampaigns`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `hungercampaigns` AS SELECT 
 1 AS `name`,
 1 AS `charity_id`,
 1 AS `target_region_id`,
 1 AS `start_date`,
...
--
-- Temporary view structure for view `ongroundcharity`
--

DROP TABLE IF EXISTS `ongroundcharity`;
/*!50001 DROP VIEW IF EXISTS `ongroundcharity`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `ongroundcharity` AS SELECT 
 1 AS `name`,
 1 AS `cause`,
 1 AS `target_region_id`*/;
SET character_set_client = @saved_cs_client;
...
CREATE TABLE `task` (
  ...
  UNIQUE KEY `id` (`id`),
  KEY `campaign_id` (`campaign_id`),
  KEY `campaign_task` (`campaign_id`,`id`),
...
--
-- Temporary view structure for view `taskvolunteers`
--

DROP TABLE IF EXISTS `taskvolunteers`;
/*!50001 DROP VIEW IF EXISTS `taskvolunteers`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `taskvolunteers` AS SELECT 
 1 AS `campaign_id`,
 1 AS `total_volunteers`*/;
SET character_set_client = @saved_cs_client;
...
--
-- Final view structure for view `activecampaigns`
--
...
/*!50001 VIEW `activecampaigns` AS select `co`.`id` AS `id`,`co`.`name` AS `name`,`co`.`cause` AS `cause`,`co`.`target_region_id` AS `target_region_id` from `charity_organization` `co` where exists(select `co`.`id`,`co`.`name`,`co`.`cause`,`co`.`target_region_id` from (`charity_organization` `co` join `campaign` `c` on((`co`.`id` = `c`.`charity_id`)))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `donationsummary`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `donationsummary` AS select `co`.`id` AS `id`,`co`.`name` AS `name`,`co`.`cause` AS `cause`,`co`.`address` AS `address`,`co`.`target_region_id` AS `target_region_id` from `charity_organization` `co` where exists(select `co`.`id`,`co`.`name`,`co`.`cause`,sum(`c`.`donation_amount`) from (`charity_organization` `co` join `donation` `c` on((`co`.`id` = `c`.`charity_id`))) group by `co`.`id`,`co`.`name`,`co`.`cause`) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `finishedcampaigns`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `finishedcampaigns` AS select `campaign`.`name` AS `name`,`campaign`.`charity_id` AS `charity_id`,`campaign`.`target_region_id` AS `target_region_id`,`campaign`.`start_date` AS `start_date`,`campaign`.`end_date` AS `end_date` from `campaign` where ((`campaign`.`end_date` is not null) and (`campaign`.`start_date` < '2022-01-01')) order by `campaign`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `hungercampaigns`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `hungercampaigns` AS select `campaign`.`name` AS `name`,`campaign`.`charity_id` AS `charity_id`,`campaign`.`target_region_id` AS `target_region_id`,`campaign`.`start_date` AS `start_date`,`campaign`.`end_date` AS `end_date` from `campaign` where ((substr(`campaign`.`name`,1,20) like '%Hunger%') and (year(`campaign`.`start_date`) < 2022)) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `ongroundcharity`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `ongroundcharity` AS select `charity_organization`.`name` AS `name`,`charity_organization`.`cause` AS `cause`,`charity_organization`.`target_region_id` AS `target_region_id` from `charity_organization` where (`charity_organization`.`target_region_id` is not null) order by `charity_organization`.`id` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `taskvolunteers`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `taskvolunteers` AS select `task`.`campaign_id` AS `campaign_id`,sum(`task`.`number_of_participants`) AS `total_volunteers` from `task` group by `task`.`campaign_id` having (sum(`task`.`number_of_participants`) > 1) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-11-12 12:25:02
